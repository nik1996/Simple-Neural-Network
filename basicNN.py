...
# Visualize the data:
plt.scatter(X[0, :], X[1, :], c=Y, s=40, cmap=plt.cm.Spectral);        ###See pic1 for output plot
...
plot_decision_boundary(lambda x: predict(parameters, x.T), X, Y)                   ###See pic3 for output plot
